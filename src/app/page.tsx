      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div className="flex-1 relative overflow-hidden">
          ...
          >
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                  ...
                  <ul className="space-y-3 text-slate-300">
                    <li className="flex items-start space-x-3">
                      ...
                      <span className="text-lg">500+ autonomous trading agents on Solana today</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <span className="text-orange-400 text-xl">•</span>
                      <span className="text-lg">Managing $1B+ in capital with hardcoded rules</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <span className="text-orange-400 text-xl">•</span>
                      <span className="text-lg">No prediction APIs = agents flying blind</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <span className="text-orange-400 text-xl">•</span>
                      <span className="text-lg">50,000+ agents projected by 2027 - all need intelligence</span>
                    </li>
                  </ul>
                </div>
            ...
            {currentSlide === 2 && (
              <Slide>
                <h2 className="text-5xl font-bold mb-6 text-center bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                  The Solution: Prediction Infrastructure for Agents & Traders
                </h2>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  ...
                  <div className="bg-gradient-to-br from-orange-500/20 to-orange-600/10 rounded-2xl p-8 border border-orange-500/30 hover:border-orange-400 transition-all group">
                    <div className="text-5xl mb-4 group-hover:scale-110 transition-transform">🧠</div>
                    <h3 className="text-2xl font-bold mb-4 text-orange-400">Agent APIs</h3>
                    <p className="text-slate-300 text-lg leading-relaxed">
                      8 intelligence modules via RESTful APIs and WebSocket streams. Machine-readable JSON predictions that autonomous agents consume to make better decisions.
                    </p>
                    <div className="mt-4 text-sm text-orange-300 font-semibold">
                      Launching Jan 2026 • 21 Endpoints
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-blue-900/30 to-blue-600/20 rounded-xl p-6 border border-blue-500/30 hover:scale-105 transition-transform">
                    ...
                    <ul className="space-y-2 text-slate-300">
                      <li className="flex items-start space-x-2">
                        ...
                        <span>API for autonomous agents integration</span>
                      </li>
                      <li className="flex items-start space-x-2">
                        <span className="text-blue-400">•</span>
            ...
            {/* Slide 5: The 8 Intelligence Modules - NEW */}
                {currentSlide === 4 && (
                  <Slide>
                    <h2 className="text-5xl font-bold mb-8 text-center bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
                      The 8 Intelligence Modules
                    </h2>
                    <p className="text-xl text-center text-slate-300 mb-12 max-w-3xl mx-auto">
                      Comprehensive prediction infrastructure that powers decision-making for agents and traders
                    </p>

                    <div className="grid md:grid-cols-2 gap-6">
                      {/* Module 1 */}
                      <div className="bg-gradient-to-br from-blue-900/40 to-blue-600/20 rounded-xl p-6 border border-blue-500/30 hover:border-blue-400 transition-all">
                        <div className="flex items-start space-x-4">
                          <div className="text-4xl">📈</div>
                          <div className="flex-1">
                            <h3 className="text-2xl font-bold mb-2 text-blue-400">1. Trading Intelligence</h3>
                            <p className="text-slate-300 mb-3">Exit predictions, timing signals, entry analysis</p>
                            <code className="text-xs text-green-400 bg-slate-900/50 px-2 py-1 rounded">
                              /api/v1/trading/exit-clusters
                            </code>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Module 2 */}
                      <div className="bg-gradient-to-br from-red-900/40 to-red-600/20 rounded-xl p-6 border border-red-500/30 hover:border-red-400 transition-all">
                        <div className="flex items-start space-x-4">
                          <div className="text-4xl">🛡️</div>
                          <div className="flex-1">
                            <h3 className="text-2xl font-bold mb-2 text-red-400">2. Risk Intelligence</h3>
                            <p className="text-slate-300 mb-3">Rug pull scoring, liquidation prediction, protocol health</p>
                            <code className="text-xs text-green-400 bg-slate-900/50 px-2 py-1 rounded">
                              /api/v1/risk/rugpull-score
                            </code>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Module 3 */}
                      <div className="bg-gradient-to-br from-purple-900/40 to-purple-600/20 rounded-xl p-6 border border-purple-500/30 hover:border-purple-400 transition-all">
                        <div className="flex items-start space-x-4">
                          <div className="text-4xl">💧</div>
                          <div className="flex-1">
                            <h3 className="text-2xl font-bold mb-2 text-purple-400">3. Liquidity Intelligence</h3>
                            <p className="text-slate-300 mb-3">Slippage prediction, optimal routing, pool analysis</p>
                            <code className="text-xs text-green-400 bg-slate-900/50 px-2 py-1 rounded">
                              /api/v1/liquidity/optimal-route
                            </code>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Module 4 */}
                      <div className="bg-gradient-to-br from-green-900/40 to-green-600/20 rounded-xl p-6 border border-green-500/30 hover:border-green-400 transition-all">
                        <div className="flex items-start space-x-4">
                          <div className="text-4xl">💎</div>
                          <div className="flex-1">
                            <h3 className="text-2xl font-bold mb-2 text-green-400">4. Opportunity Intelligence</h3>
                            <p className="text-slate-300 mb-3">New launches, arbitrage, yield optimization</p>
                            <code className="text-xs text-green-400 bg-slate-900/50 px-2 py-1 rounded">
                      ...
                      {/* Module 5 */}
                      <div className="bg-gradient-to-br from-yellow-900/40 to-yellow-600/20 rounded-xl p-6 border border-yellow-500/30 hover:border-yellow-400 transition-all">
                        <div className="flex items-start space-x-4">
                          <div className="text-4xl">👁️</div>
                          <div className="flex-1">
                            <h3 className="text-2xl font-bold mb-2 text-yellow-400">5. Sentiment Intelligence</h3>
                            <p className="text-slate-300 mb-3">Social signals, whale tracking, momentum</p>
                            <code className="text-xs text-green-400 bg-slate-900/50 px-2 py-1 rounded">
                              /api/v1/sentiment/whale-activity
                            </code>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Module 6 */}
                      <div className="bg-gradient-to-br from-cyan-900/40 to-cyan-600/20 rounded-xl p-6 border border-cyan-500/30 hover:border-cyan-400 transition-all">
                        <div className="flex items-start space-x-4">
                          <div className="text-4xl">💰</div>
                          <div className="flex-1">
                            <h3 className="text-2xl font-bold mb-2 text-cyan-400">6. Capital Efficiency</h3>
                            <p className="text-slate-300 mb-3">Portfolio optimization, position sizing</p>
                            <code className="text-xs text-green-400 bg-slate-900/50 px-2 py-1 rounded">
                              /api/v1/capital/portfolio-optimize
                            </code>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Module 7 */}
                      <div className="bg-gradient-to-br from-pink-900/40 to-pink-600/20 rounded-xl p-6 border border-pink-500/30 hover:border-pink-400 transition-all">
                        <div className="flex items-start space-x-4">
                          <div className="text-4xl">📊</div>
                          <div className="flex-1">
                            <h3 className="text-2xl font-bold mb-2 text-pink-400">7. Volatility Intelligence</h3>
                            <p className="text-slate-300 mb-3">Forecasting, IV analysis, hedging signals</p>
                            <code className="text-xs text-green-400 bg-slate-900/50 px-2 py-1 rounded">
                      ...
                      {/* Module 8 */}
                      <div className="bg-gradient-to-br from-emerald-900/40 to-emerald-600/20 rounded-xl p-6 border border-emerald-500/30 hover:border-emerald-400 transition-all">
                        <div className="flex items-start space-x-4">
                          <div className="text-4xl">🏦</div>
                          <div className="flex-1">
                            <h3 className="text-2xl font-bold mb-2 text-emerald-400">8. Stablecoin Intelligence</h3>
                            <p className="text-slate-300 mb-3">Yield optimization, treasury management, depeg risk</p>
                            <code className="text-xs text-green-400 bg-slate-900/50 px-2 py-1 rounded">
                              /api/v1/stablecoin/yield-optimization
                            </code>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="mt-8 bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-xl p-6 border border-blue-500/30 text-center">
                      <p className="text-xl font-semibold text-blue-300 mb-2">
                        🚀 21 API Endpoints | JavaScript, Python, Rust SDKs | WebSocket Streams
                      </p>
                      <p className="text-slate-400">
                        Launch: January 2026 | Developer Waitlist: 500+ agents
                      </p>
                    </div>
                  </Slide>
                )}
            ...
            {currentSlide === 6 && (
              <Slide>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                  ...
                  <div className="flex items-center space-x-3 mb-4">
                    <div className="text-4xl">🤖</div>
                    <h3 className="text-2xl font-bold text-orange-400">Agent Economy TAM</h3>
                  </div>
                  <div className="space-y-3 text-slate-300">
                    <div className="flex justify-between items-center">
                      <span>Current (2025):</span>
                      <span className="font-bold text-orange-400">$12M/year</span>
                    </div>
                    <div className="text-sm text-slate-400">500 agents × $2K/month</div>
                    <div className="h-px bg-orange-500/30 my-2"></div>
                    <div className="flex justify-between items-center">
                      <span>Projected (2027):</span>
                      <span className="font-bold text-orange-400">$1.2B/year</span>
                    </div>
                    <div className="text-sm text-slate-400">50,000 agents × $2K/month</div>
                    <div className="h-px bg-orange-500/30 my-2"></div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm">Conservative 10% capture:</span>
                      <span className="font-bold text-2xl text-orange-300">$120M</span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-gradient-to-br from-green-900/30 to-emerald-600/20 rounded-xl p-8 border border-green-500/30">
                    ...
                    <div className="space-y-5">
                     <div className="text-center bg-gradient-to-r from-purple-600/20 to-blue-600/20 rounded-xl p-8 border border-purple-500/30">
                      <p className="text-slate-400 text-xl mb-2">Combined Total Addressable Market</p>
                      <p className="text-6xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                        $29B+
                      </p>
                      <p className="text-slate-400 mt-2">$28B Retail + $1.2B Agent Economy</p>
                    </div>
                      <div>
                  ...
                  <div className="bg-gradient-to-br from-purple-900/30 to-pink-600/20 rounded-xl p-8 border border-purple-500/30">
                    ...
                    <div className="space-y-4 text-slate-300">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <p className="font-semibold">100+ autonomous agents integrate OUR predictions</p>
